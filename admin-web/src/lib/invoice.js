// Invoice HTML for print — same layout and logo as the mobile APK PDF.
import { formatDate } from './helpers';
import { LOGO_BASE64 } from './logoBase64';

export function generateInvoiceHTML(invoiceData, entries = []) {
  const {
    invoice_number,
    customer_name,
    invoice_date,
  ...
  const logoBlock = logoDataUri
    ? `<img src="${logoDataUri}" style="width:80px;height:80px;object-fit:contain;" alt="Logo" />`
    : `<div class="logo">MANJULA<br/>MILK<br/>FORMING</div>`;
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .customer-section strong { color: #1F4D1C; }
    table {
      width: 100%;
    ...
    .total-row { background: #1F4D1C !important; }
    .total-row td {
